...
#include "fuse.h"
#include "pm.h"
#if defined(CONFIG_TEGRA_BB_XMM_POWER) || defined(CONFIG_TEGRA_BB_XMM_POWER2)
#include "baseband-xmm-power.h"
#endif
#include "wdt-recovery.h"
#ifdef CONFIG_XMM6260
#include <xmm6260.h>
#endif
...
#if defined(CONFIG_TEGRA_BB_XMM_POWER) || defined(CONFIG_XMM6260)
...
#if defined(CONFIG_TEGRA_BB_XMM_POWER2)
...
static void cardhu_modem_init(void)
{
	...
	case BOARD_PM269:
		printk("BOARD_PM269");
#if defined(CONFIG_TEGRA_BB_XMM_POWER) || defined(CONFIG_TEGRA_BB_XMM_POWER2) || defined(CONFIG_XMM6260)
